...
export double ex_bass_init(LPSTR dllfile,double window_handle)
{

 dll_handle = LoadLibrary(dllfile);
...
/* STREAMS */
export double ex_bass_stream_load(LPSTR file)
{
     return BASS_load(FALSE, file, 0, 0, 0);
}

export double ex_bass_stream_free(double filehandle)
{
...
export double ex_bass_stream_play(double filehandle)
{
...
export double ex_bass_stream_loop(double filehandle)
{
...
export double ex_bass_stream_set_loop(double filehandle,double attrflag)
{
       if (attrflag == 1)
       {
          if (BASS_flags((DWORD)filehandle, BASS_SAMPLE_LOOP, BASS_SAMPLE_LOOP))
...
export double ex_bass_stream_get_loop(double filehandle)
{
...
export double ex_bass_set_device(double device)
{
...
export double ex_bass_get_device()
{

   return (double)BASS_get_device();
}

export double ex_bass_set_global_volume(double amount)
{
...
export double ex_bass_get_global_volume()
{
      return (double)BASS_get_config(BASS_CONFIG_GVOL_STREAM);
}

export double ex_bass_get_master_volume()
{
       return (double)BASS_get_mvolume();
}

export double ex_bass_set_master_volume(double amount)
{
...
export double ex_bass_stream_get_volume(double filehandle)
{
       float value;
...
export double ex_bass_stream_get_pitch(double filehandle)
{
       float value;
...
export double ex_bass_stream_get_pan(double filehandle)
{
       float value;
...
export double ex_bass_stream_set_volume(double filehandle, double amount)
{
...
export double ex_bass_stream_set_pitch(double filehandle, double amount)
{
...
export double ex_bass_stream_set_pan(double filehandle, double amount)
{
...
export double ex_bass_stream_resume(double filehandle)
{
...
export double ex_bass_stream_pause(double filehandle)
{
...
export double ex_bass_stream_stop(double filehandle)
{
...
export double ex_bass_error_get_code()
{
       return (double)BASS_error_get_code();
}

export double ex_bass_get_cpu()
{
       return (double)BASS_get_cpu();
}

export double ex_bass_close()
{
       if(!BASS_close()){return 0;}
       if(!FreeLibrary(dll_handle)){return -1;}

       return 1;
}

export double ex_bass_stream_fade_volume(double filehandle,double amount,double time)
{
...
export double ex_bass_stream_fade_pan(double filehandle,double amount,double time)
{
...
export double ex_bass_stream_fade_pitch(double filehandle,double amount,double time)
{
...
export double ex_bass_stream_is_playing(double filehandle)
{
...
export double ex_bass_stream_is_paused(double filehandle)
{
...
export double ex_bass_stream_is_stopped(double filehandle)
{
...
export double ex_bass_stream_volume_is_fading(double filehandle)
{
...
export double ex_bass_stream_pitch_is_fading(double filehandle)
{
...
export double ex_bass_stream_pan_is_fading(double filehandle)
{
...
export double ex_bass_stream_set_position_seconds(double filehandle, double pos)
{
       double spos;
...
export double ex_bass_stream_set_position_bytes(double filehandle, double pos)
{
     if (BASS_set_position((DWORD)filehandle, (QWORD)pos, BASS_POS_BYTE))
     {return 1;}else{return 0;}
}

export double ex_bass_stream_get_position_seconds(double filehandle)
{
...
export double ex_bass_stream_get_position_bytes(double filehandle)
{
       return BASS_get_position((DWORD)filehandle, BASS_POS_BYTE);
}

export double ex_bass_stream_get_length_bytes(double filehandle)
{
       return (double)BASS_get_length((DWORD)filehandle, BASS_POS_BYTE);
}

export double ex_bass_stream_get_length_seconds(double filehandle)
{
       DWORD pos;
...
export double ex_bass_sample_load(LPSTR file)
{
     return BASS_load_sample(FALSE, file, 0, 0, 65534, 0);
}

export double ex_bass_sample_play(double filehandle)
{
    DWORD chan;
...
export double ex_bass_sample_stop(double filehandle)
{
    return BASS_sample_stop((DWORD)filehandle);
}

export double ex_bass_sample_free(double filehandle)
{
    return BASS_sample_free((DWORD)filehandle);
}

export double ex_bass_sample_set_volume(double filehandle, double amount)
{
    BASS_SAMPLE info;
...
export double ex_bass_sample_get_volume(double filehandle)
{
    BASS_SAMPLE info;
...
export double ex_bass_sample_set_pitch(double filehandle, double amount)
{
    BASS_SAMPLE info;
    BASS_sample_get_info((DWORD)filehandle, &info);
...
export double ex_bass_sample_get_pitch(double filehandle)
{
    BASS_SAMPLE info;
    if (BASS_sample_get_info((DWORD)filehandle, &info))
    {
...
export double ex_bass_sample_set_pan(double filehandle, double amount)
{
    BASS_SAMPLE info;
    BASS_sample_get_info((DWORD)filehandle, &info);
...
export double ex_bass_sample_get_pan(double filehandle)
{
    BASS_SAMPLE info;
    if (BASS_sample_get_info((DWORD)filehandle, &info))
    {
